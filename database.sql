...
CREATE TABLE SUBSCRIPTION(
    ...
    CONSTRAINT fk_subsciption_user FOREIGN KEY (id_user) REFERENCES USER(id_user)
);
...
CREATE TABLE PRODUCT(
    ...
    CONSTRAINT fk_product_offer FOREIGN KEY (id_offer) REFERENCES CATEGORY(id_offer)
);
...
CREATE TABLE VOUCHER(
    ...
    CONSTRAINT fk_voucher_cart FOREIGN KEY (id_cart) REFERENCES CART(id_cart),
...
CREATE TABLE ORDER(
    ...
    CONSTRAINT fk_order_commune FOREIGN KEY (id_commune) REFERENCES COMMUNE(id_commune),
    CONSTRAINT fk_order_voucher FOREIGN KEY (id_voucher) REFERENCES VOUVHER(id_voucher),
...
ALTER TABLE BRANCH MODIFY id_branch INT(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT = 1;

-- Regiones de Chile

INSERT INTO regions VALUES(1, "Arica y Parinacota", "XV");
INSERT INTO regions VALUES(2, "Tarapaca", "I");
INSERT INTO regions VALUES(3, "Antofagasta", "II");
INSERT INTO regions VALUES(4, "Atacama", "III");
INSERT INTO regions VALUES(5, "Coquimbo", "IV");
INSERT INTO regions VALUES(6, "Valparaíso", "V");
INSERT INTO regions VALUES(7, "Libertador General Bernardo O'Higgins", "VI");
INSERT INTO regions VALUES(8, "Maule", "VII");
INSERT INTO regions VALUES(9, "Ñuble", "XVI");
INSERT INTO regions VALUES(10, "Biobio", "VIII");
INSERT INTO regions VALUES(11, "La Araucania", "IX");
INSERT INTO regions VALUES(12, "Los Rios", "XIV");
INSERT INTO regions VALUES(13, "Los Lagos", "X");
INSERT INTO regions VALUES(14, "Aysen del General Carlos Ibañez del Campo", "XI");
INSERT INTO regions VALUES(15, "Magallanes y de la Antartica Chilena ", "XII");
INSERT INTO regions VALUES(16, "Metropolitana de Santiago", "");
...
INSERT INTO provinces VALUES(4, "Tamarugal", 2);

INSERT INTO provinces VALUES(5, "Tocopilla", 3);
INSERT INTO provinces VALUES(6, "El Loa", 3);
INSERT INTO provinces VALUES(7, "Antofagasta", 3);

INSERT INTO provinces VALUES(8, "Chañaral", 4);
INSERT INTO provinces VALUES(9, "Copiapo", 4);
INSERT INTO provinces VALUES(10, "Huasco", 4);

INSERT INTO provinces VALUES(11, "Elqui", 5);
INSERT INTO provinces VALUES(12, "Limari", 5);
INSERT INTO provinces VALUES(13, "Choapa", 5);

INSERT INTO provinces VALUES(14, "Petorca", 6);
INSERT INTO provinces VALUES(15, "Los Andes", 6);
INSERT INTO provinces VALUES(16, "San Felipe de Aconcagua", 6);
INSERT INTO provinces VALUES(17, "Quillota", 6);
INSERT INTO provinces VALUES(18, "Valparaiso", 6);
INSERT INTO provinces VALUES(19, "San Antonio", 6);
INSERT INTO provinces VALUES(20, "Isla de Pascua", 6);
INSERT INTO provinces VALUES(21, "Marga Marga", 6);

INSERT INTO provinces VALUES(22, "Chacabuco", 16);
INSERT INTO provinces VALUES(23, "Santiago", 16);
INSERT INTO provinces VALUES(24, "Cordillera", 16);
INSERT INTO provinces VALUES(25, "Maipo", 16);
INSERT INTO provinces VALUES(26, "Melipilla", 16);
INSERT INTO provinces VALUES(27, "Talagante", 16);

INSERT INTO provinces VALUES(28, "Cachapoal", 7);
INSERT INTO provinces VALUES(29, "Colchagua", 7);
INSERT INTO provinces VALUES(30, " Cardenal Caro", 7);

INSERT INTO provinces VALUES(31, "Curico", 8);
INSERT INTO provinces VALUES(32, "Talca", 8);
INSERT INTO provinces VALUES(33, "Linares", 8);
INSERT INTO provinces VALUES(34, "Cauquenes", 8);

INSERT INTO provinces VALUES(35, "Diguillin", 9);
INSERT INTO provinces VALUES(36, "Itata", 9);
INSERT INTO provinces VALUES(37, "Punilla", 9);

INSERT INTO provinces VALUES(38, "Biobio", 10);
INSERT INTO provinces VALUES(39, "Concepcion", 10);
INSERT INTO provinces VALUES(40, "Arauco", 10);

INSERT INTO provinces VALUES(41, "Malleco", 11);
INSERT INTO provinces VALUES(42, "Cautin", 11);

INSERT INTO provinces VALUES(43, "Valdivia", 12);
INSERT INTO provinces VALUES(44, "Ranco", 12);

INSERT INTO provinces VALUES(45, "Osorno", 13);
INSERT INTO provinces VALUES(46, "Llanquihue", 13);
INSERT INTO provinces VALUES(47, "Chiloe", 13);
INSERT INTO provinces VALUES(48, "Palena", 13);

INSERT INTO provinces VALUES(49, "Coyhaique", 14);
INSERT INTO provinces VALUES(50, "Aysen", 14);
INSERT INTO provinces VALUES(51, " General Carrera", 14);
INSERT INTO provinces VALUES(52, " Capitan Prat", 14);

INSERT INTO provinces VALUES(53, "Ultima Esperanza", 15);
INSERT INTO provinces VALUES(54, "Magallanes", 15);
INSERT INTO provinces VALUES(55, "Tierra del Fuego", 15);
INSERT INTO provinces VALUES(56, " Antartica Chilena", 15);
